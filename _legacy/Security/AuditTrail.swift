...
//
//  HASH-SERIALISIERUNG:
//  Payload = "previousHash|action|key|userId|timestamp" (pipe-delimited, feste Reihenfolge)
//  Gleiche computeHash() für log() und verifyIntegrity() → deterministische Kette.
//
...
final class AuditTrail {
    ...
    /// Hash-Payload: Feste Reihenfolge, Pipe-getrennt.
    /// Dieselbe Funktion für log() und verifyIntegrity() → deterministische Kette.
