...
//  Status: Kopiert 1:1 – braucht SwiftData-Anpassung in Phase 5
//
//  Aktuell referenziert CoreData-Typen:
//  - Auftrag (NSManagedObject)
//  - NSManagedObjectContext
//  - NSFetchRequest
//  - AuftragExtrasPayload, AuftragStatus, NutritionSnapshot
//
//  Phase 5 TODO: CoreData → SwiftData migrieren
//  - Auftrag → @Model class
//  - NSFetchRequest → #Predicate + FetchDescriptor
...
final class KernelBridge {
    ...
    func registerJob(_ auftrag: Auftrag) {
        ...
        TaskRepository.createProductionTask(
            id: id,
            title: title,
            weight: weight
        )
