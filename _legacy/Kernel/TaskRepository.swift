...
//  iMOPS-Gastro-Grid
//
//  Merged from: iMOPS-Haccp (TaskRepository) + test25B (KernelTaskRepository)
//  Difference: iMOPS-Haccp version adds haccpRef parameter to createProductionTask()
//  Base: iMOPS-Haccp version (superset)
//
